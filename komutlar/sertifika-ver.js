...
message.channel.send("✅ **|** Başarıyla Bota Sertifika Verdiniz.")
  
   message.guild.members.cache.get(botid).roles.add(botlist.sertifikabot)
 message.guild.members.cache.get(sahip).roles.add(botlist.sertifikalıdevel)
  
  let embed = new Discord.MessageEmbed()
  .setColor("RANDOM")
.setDescription(`:white_check_mark:  **|**  <@${botid}> Adlı Bota Sertifika Verilmiştir.`)
